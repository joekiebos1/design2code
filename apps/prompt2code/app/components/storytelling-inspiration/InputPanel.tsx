...
export function InputPanel({ onSubmit, isLoading }: InputPanelProps) {
  ...
  const [productType, setProductType] = useState<StoryCoachInput['productType']>('hardware')
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    onSubmit({ outputType, productType, productName, whatItDoes, whatIsInIt, builtFor })
  }
