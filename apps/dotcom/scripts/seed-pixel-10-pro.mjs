...
async function seed() {
  ...
  const sections = [
    // 1. HeroBlock – product hero
    {
      ...
      emphasis: 'ghost',
      spacingBottom: 'large',
      eyebrow: 'Pixel 10 Pro',
      title: 'Meet the new status pro.',
      body: 'From £999 or £27.75/month with 36-month financing',
      ctaText: 'Buy',
    ...
    // 3. CarouselBlock – New on Pixel 10 Pro (large 8-col cards, 8:5)
    {
      ...
      items: [
        { _type: 'cardItem', _key: 'n1', cardType: 'mediaTextBelow', title: 'With Nano Banana in Gemini, take your photos even further', description: 'Imagine yourself in different scenes, combine creative elements, make specific edits and more. It\'s easier than ever to bring your ideas to life.', videoUrl: VIDEO.n1 },
        { _type: 'cardItem', _key: 'n2', cardType: 'mediaTextBelow', title: 'Simply describe your idea', description: 'Pixel will create a high-quality short video with sound for you.', videoUrl: VIDEO.n2 },
        { _type: 'cardItem', _key: 'n3', cardType: 'mediaTextBelow', title: 'Make high-motion scenes feel cinematic', description: 'Improved stabilisation powered by Video Boost.', videoUrl: VIDEO.n3 },
        { _type: 'cardItem', _key: 'n4', cardType: 'mediaTextBelow', title: 'Magic Cue', description: 'All-new AI for Pixel that gives you the info you need, right as you need it.', videoUrl: VIDEO.n4 },
        { _type: 'cardItem', _key: 'n5', cardType: 'mediaTextBelow', title: 'Pro Zoom with up to 100x zoom range', description: 'The longest, sharpest zoom of any Pixel.', videoUrl: VIDEO.n5 },
        { _type: 'cardItem', _key: 'n6', cardType: 'mediaTextBelow', title: 'Talk with Gemini about anything you see', description: 'Using your camera in Gemini Live.', videoUrl: VIDEO.n6 },
        { _type: 'cardItem', _key: 'n7', cardType: 'mediaTextBelow', title: 'Meet Camera Coach', description: 'Uses Gemini models to read the scene and help you set up the best pic.', videoUrl: VIDEO.n7 },
      ],
    },
    ...
    // 5. CarouselBlock – Gemini features (tight to intro above)
    {
      ...
      emphasis: 'ghost',
      items: [
        { _type: 'cardItem', _key: 'g1-m', cardType: 'mediaTextBelow', videoUrl: VIDEO.g1 },
        { _type: 'cardItem', _key: 'g1-t', cardType: 'colourFeatured', title: 'Set your creative ideas in motion', description: 'Create a high-quality short video, complete with natural-sounding audio, simply by describing your idea.', backgroundColor: 'primary-bold' },
        { _type: 'cardItem', _key: 'g2-m', cardType: 'mediaTextBelow', videoUrl: VIDEO.g2 },
        { _type: 'cardItem', _key: 'g2-t', cardType: 'colourFeatured', title: 'Talk to Gemini about anything you see', description: 'Share your camera in Gemini Live to have a back-and-forth chat about what\'s around you.', backgroundColor: 'primary-bold' },
        { _type: 'cardItem', _key: 'g3-m', cardType: 'mediaTextBelow', videoUrl: VIDEO.g3 },
        { _type: 'cardItem', _key: 'g3-t', cardType: 'colourFeatured', title: 'Ask Gemini about anything, from anywhere', description: 'Go Live with Gemini to have a natural, free-flowing conversation. Just start talking to get info, brainstorm ideas and more.', backgroundColor: 'primary-bold' },
        { _type: 'cardItem', _key: 'g4-m', cardType: 'mediaTextBelow', title: 'Talk through whatever\'s on your screen', image: imageRef(getAsset(7)) },
        { _type: 'cardItem', _key: 'g4-t', cardType: 'colourFeatured', title: 'Talk through whatever\'s on your screen', description: 'Curious about something you\'re browsing? Just ask Gemini for more details.', backgroundColor: 'primary-bold' },
        { _type: 'cardItem', _key: 'g5-m', cardType: 'mediaTextBelow', videoUrl: VIDEO.g5 },
        { _type: 'cardItem', _key: 'g5-t', cardType: 'colourFeatured', title: 'Ask Gemini to multitask across your apps', description: 'Save time by asking Gemini to find info and get things done for you - like checking your calendar, then texting a reminder.', backgroundColor: 'primary-bold' },
      ],
    },
    ...
    // 7. CarouselBlock – Gemini on Pixel (2 cards: Gemini + Google AI Pro)
    {
      ...
      items: [
        { _type: 'cardItem', _key: 'gp1', cardType: 'colourFeatured', title: 'Gemini', description: 'Get a built-in AI assistant that helps you write, plan, learn and get things done. Share your camera or screen in Gemini Live. Go live with Gemini whenever it\'s easier to just talk. Brainstorm ideas, write stories and plan big projects.', aspectRatio: '4:5', backgroundColor: 'primary-bold' },
        { _type: 'cardItem', _key: 'gp2', cardType: 'colourFeatured', title: 'Google AI Pro', description: 'Unlock more access to our powerful features and most capable AI models. Deep Research. Create 8-second videos with Veo 3.1. NotebookLM. Flow. 2 TB of cloud storage.', aspectRatio: '4:5', backgroundColor: 'primary-bold' },
      ],
    },
    ...
    // 10. CarouselBlock – Camera lenses (4 cards)
    {
      ...
      items: [
        { _type: 'cardItem', _key: 'l1', cardType: 'mediaTextBelow', title: '48 MP ultrawide', description: 'Play up any angle like a pro. Go into greater detail with super-sharp Macro Focus, or capture sweeping, wide-angle landscape shots.', image: imageRef(getAsset(2)), aspectRatio: '4:5' },
        { _type: 'cardItem', _key: 'l2', cardType: 'mediaTextBelow', title: '50 MP wide', description: 'Our best camera yet. Capture beautiful portraits and vivid low-light photos and videos with its ƒ/1.68 aperture.', image: imageRef(getAsset(3)), aspectRatio: '4:5' },
        { _type: 'cardItem', _key: 'l3', cardType: 'mediaTextBelow', title: '48 MP telephoto', description: "Pixel 10 Pro's upgraded 5x telephoto lens has our longest and best zoom quality ever. Up to 100x Pro Res Zoom.", image: imageRef(getAsset(4)), aspectRatio: '4:5' },
        { _type: 'cardItem', _key: 'l4', cardType: 'mediaTextBelow', title: '42 MP front-facing', description: "Pixel's widest selfie camera with autofocus features a 103° field of view. Sharper selfies from any angle.", image: imageRef(getAsset(5)), aspectRatio: '4:5' },
      ],
    },
    // 11. CarouselBlock – Super steady videos (4 sub-features)
    {
      ...
      items: [
        { _type: 'cardItem', _key: 'v1', cardType: 'mediaTextBelow', title: 'Up to 20x the video zoom power', description: 'Zoom in up to 20x with Super Res Zoom Video, enabled by a powerful telephoto lens and advanced processing.', videoUrl: VIDEO.v1, aspectRatio: '4:5' },
        { _type: 'cardItem', _key: 'v2', cardType: 'mediaTextBelow', title: 'Low-light videos get a glow-up', description: 'Night Sight Video brings out the best, highest-quality 8K recordings on a Pixel.', videoUrl: VIDEO.v2, aspectRatio: '4:5' },
        { _type: 'cardItem', _key: 'v3', cardType: 'colourFeatured', title: '100x. Pixel\'s longest zoom ever', description: 'Zoom like never before with up to 100x Pro Zoom. Powered by an upgraded telephoto camera and all-new AI imaging.', aspectRatio: '4:5', backgroundColor: 'primary-bold' },
        { _type: 'cardItem', _key: 'v4', cardType: 'mediaTextBelow', title: '50 MP portraits from a smartphone', description: "Pixel's best portrait quality to date. Get high-res images worthy of professional editing and printing right from your phone.", image: imageRef(getAsset(6)), aspectRatio: '4:5' },
      ],
    },
    ...
    // 19. CarouselBlock – Add a little extra help (4 accessories)
    {
      ...
      items: [
        { _type: 'cardItem', _key: 'acc1', cardType: 'mediaTextBelow', title: 'Pixel 10, Pro, Pro XL Case', description: 'Protection that meets your style.', image: imageRef(getAsset(12)), aspectRatio: '4:5', link: 'https://store.google.com/gb/product/pixel_10_pro_phone_case?hl=en-GB', ctaText: 'Learn more' },
        { _type: 'cardItem', _key: 'acc2', cardType: 'mediaTextBelow', title: 'Pixelsnap Charger', description: 'Fast wireless charging.', videoUrl: VIDEO.acc2, aspectRatio: '4:5', link: 'https://store.google.com/gb/product/pixelsnap_charger?hl=en-GB', ctaText: 'Learn more' },
        { _type: 'cardItem', _key: 'acc3', cardType: 'mediaTextBelow', title: 'Pixelsnap Ring Stand', description: 'Hold your phone anywhere.', image: imageRef(getAsset(13)), aspectRatio: '4:5', link: 'https://store.google.com/gb/product/pixelsnap_ring_stand?hl=en-GB', ctaText: 'Learn more' },
        { _type: 'cardItem', _key: 'acc4', cardType: 'mediaTextBelow', title: 'Pixelsnap Charger with Stand', description: 'Charge and stand in one.', image: imageRef(getAsset(14)), aspectRatio: '4:5', link: 'https://store.google.com/gb/product/pixelsnap_charger_stand?hl=en-GB', ctaText: 'Learn more' },
      ],
    },
