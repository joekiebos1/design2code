...
/** Figma → code preview: same `sections` shape as `page` (production pageBuilder). */
export const figmaDesignBySlugQuery = `*[_type == "figmaDesign" && slug.current == $slug][0]{
  _id,
  title,
  "slug": slug.current,
  figmaFileUrl,
...
const LAB_SECTIONS_PROJECTION = `{
  ...
  _key,
  _type == "mediaTextStacked" => ${S_MEDIA_TEXT_STACKED},
  _type == "labMediaTextStacked" => ${S_MEDIA_TEXT_STACKED},
  _type == "mediaTextBlock" => ${S_MEDIA_TEXT_BLOCK},
  _type == "mediaText5050" => ${S_MEDIA_TEXT_5050},
  ...
  _type == "labFullBleedVerticalCarousel" => {
    spacingTop,
    spacingBottom,
    emphasis,
    "appearance": coalesce(appearance, surfaceColour),
  ...
  _type == "iconGrid" => ${S_ICON_GRID},
  _type == "labIconGrid" => ${S_ICON_GRID},
  _type == "proofPoints" => ${S_PROOF_POINTS},
  _type == "labProofPoints" => ${S_PROOF_POINTS},
  _type == "mediaTextAsymmetric" => ${S_MEDIA_TEXT_ASYMMETRIC},
