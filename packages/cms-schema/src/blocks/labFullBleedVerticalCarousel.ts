...
export const labFullBleedVerticalCarouselItem = defineType({
  name: 'labFullBleedVerticalCarouselItem',
  type: 'object',
  title: 'Carousel item',
  fields: [
    defineField({
...
export const labFullBleedVerticalCarouselBlock = defineType({
  name: 'labFullBleedVerticalCarousel',
  type: 'object',
  ...
  fields: [
    ...
    defineField({
      ...
      of: [{ type: 'labFullBleedVerticalCarouselItem' }],
    }),
  ],
  preview: {
