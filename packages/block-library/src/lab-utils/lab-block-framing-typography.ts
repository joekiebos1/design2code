...
/** Eyebrow above section title (carousel, card grid framing). Centre-aligned stacks only in those blocks. */
export const labBlockFramingEyebrowStyle: CSSProperties = {
  margin: 0,
  whiteSpace: 'pre-line',
}
