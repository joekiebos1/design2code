...
type ProofPointsBlockAppearance = 'primary' | 'secondary' | 'sparkle' | 'neutral'
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--ds-spacing-xs)' }}>
        ...
        {item.title && (
          <Headline size="S" weight="medium" as={itemLevel} align="center" style={{ margin: 0, fontSize: TYPOGRAPHY.labelM, whiteSpace: 'pre-line' }}>
            {item.title}
          </Headline>
        )}
      </div>
